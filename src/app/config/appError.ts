const appError = {
  ...
  LOCATION_EXIST: "This location already exists",
  REGION_EXIST: "This region already exists",
  CUSTOMER_EXIST: "This customer already exists",
  INCORRECT_LOGIN_DATA: "Username or password is incorrect!",
